    ...
    <div className="grid grid-cols-4 gap-4">
        {
            tasks.length > 0 ?
             ...
             tasks.map((row,i)=>(
                // <div key={i} className="bg-amber-900 p-4 rounded shadow-md hover:bg-amber-700 flex flex-col items-center justify-center text-center">
                ...
                //         <p className={`text-base font-bold ${row.status === 'pendiente' ? 'text-red-500' : 'text-green-500'}`}>
                //             Estado: {row.status}
                //         </p>

                //     <div className="flex gap-2 mt-2">
                //         <button className="bg-amber-300 p-1 hover:bg-amber-100 rounded-2xl text-amber-950">Editar</button>
                //         <button className="bg-amber-600 p-1 hover:bg-amber-400 rounded-2xl">Borrar</button>
                //     </div>
                // </div>

...
const InputTasks = ({handleShowInputTask, id, setShowInputTask}:{handleShowInputTask: ()=> void; id:string; setShowInputTask: (value: boolean) => void }) => {
